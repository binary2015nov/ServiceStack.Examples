...
<head runat="server">
    <title>ServiceStack Examples :: SOAP 1.1 Web Services</title>
...
<body class="soap-page">
    ...
    <div class="note">
        ...
        The source code for this ASP.NET page is <a href="https://github.com/ServiceStack/ServiceStack.Examples/tree/master/src/ServiceStack.Examples/ServiceStack.Examples.Clients/Soap11.aspx.cs">available here</a>.
    </div>
    ...
    <p>
        ...
        <a id="btn-download" href="https://github.com/ServiceStack/ServiceStack.Examples/downloads">
            <img src="https://servicestack.net/btn-download.gif" alt="Download ServiceStack.Examples.zip">
        </a>
    </p>
    ...
    <div id="footer-links">
        ...
        <a href="https://servicestack.net">Service Stack</a>
